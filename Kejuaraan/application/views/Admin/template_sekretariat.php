    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Kejuaraan</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i> Peserta<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Semua</a>
                                </li>
                                <li>
                                    <a href="morris.html">Usia Dini</a>
                                </li>
                                <li>
                                    <a href="morris.html">Pra Remaja</a>
                                </li>
                                <li>
                                    <a href="morris.html">Remaja</a>
                                </li>
                                <li>
                                    <a href="morris.html">Dewasa</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Pertandingan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Semua</a>
                                </li>
                                <li>
                                    <a href="morris.html">Tanding</a>
                                </li>
                                <li>
                                    <a href="morris.html">Seni</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
